...
int main()
{
    ...
    cout << "List : ";
    display(first);
    cout << "Maximum Element : " << maximum(first) << endl;
    cout << "List : ";
    display(first);
    cout << "Maximum Element : " << r_maximum(first) << endl;
    return 0;
}
